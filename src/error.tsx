      ...
      <div className="h-[200vh]">
        <div className="fixed flex flex-col gap-8 px-12 md:px-[20vw] w-[100vw] h-[100vh] bg-black overflow-hidden justify-center items-center"> 
          <div className="self-start relative" id="code">
            <h1 className="text-[8rem] text-white top-0">{error.digest}</h1>
            <h1 className="text-[8rem] text-[rgba(0,255,0,1)] absolute translate-[2px] top-0 animate-pulse duration-[2s]">{error.digest}</h1> 
            <h1 className="text-[8rem] text-[rgba(255,0,0,1)] absolute translate-[-2px] top-0 animate-pulse">{error.digest}</h1>
            <h1 className="text-[8rem] text-white top-0 absolute">{error.digest}</h1>
          </div>
          <div>
